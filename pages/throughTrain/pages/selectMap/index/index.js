...
Page({
    ...
    request({
      ...
      if(res.code == 200 && res.data){
        this.setData({
          ...
          this.getcenter(res.data.start.point)
  ...
  goFromLoc(){
    wx.navigateTo({
      url: '/pages/throughTrain/pages/selectMap/locList/index?type=from',
    })
    this.setData({
     isgetloc:false
    })
  ...
  goEndLoc(){
    wx.navigateTo({
      url: '/pages/throughTrain/pages/selectMap/locList/index?type=to',
    })
  ...
  mapOk(){
    ...
    if(this.data.fromloc !== ''){
      ...
      wx.navigateTo({
        url: '/pages/throughTrain/pages/order/index?carInfo='+JSON.stringify(this.data.carInfo)
      })
    }
  },
  //地图定位
