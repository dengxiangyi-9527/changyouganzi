...
import { coordinateLoc } from '../../../../utils/coordinateLoc'
...
Page({
  ...
  goFromLoc(){
    wx.navigateTo({
      url: '/pages/cjjs/mapselect/locList/index?type=from',
    })
    this.setData({
      isFrom:true,
     isgetloc:false
  ...
  goEndLoc(){
    wx.navigateTo({
      url: '/pages/cjjs/mapselect/locList/index?type=to',
    })
  ...
  mapOk(){
    ...
    if(this.data.fromloc !== '' && this.data.endloc !== ''){
      ...
      wx.navigateTo({
        url: '/pages/cjjs/neworder/index?carsInfo='+carsInfo+'&timer='+timer+'&start_station='+start_station+'&end_station='+end_station+'&orderDetail='+''
      })
    }
  },
  //地图定位
