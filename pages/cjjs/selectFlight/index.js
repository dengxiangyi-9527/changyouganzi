...
Page({
      ...
      request({
        ...
        if(res.code == 200){
          ...
          console.log(orderDetail !== '')
            ...
            wx.navigateTo({
              url: '/pages/cjjs/neworder/index?carsInfo='+carsInfo+'&timer='+timer+'&start_station='+start_station+'&end_station='+end_station+'&orderDetail='+ JSON.stringify(orderDetail)
            })
            ...
            wx.navigateTo({
              url: '/pages/cjjs/mapselect/index/index?carsInfo='+carsInfo+'&timer='+timer,
            })
          }
  ...
  goDingzhi(){
    wx.navigateTo({
      url: '/pages/cjjs/charteredBus/index',
    })
  },
  //页面加载的时候
