            ...
            success:() => {
              wx.requestPayment({
                ...
                success:(res)=> {
                  ...
                  wx.redirectTo({
                    url: '/pages/throughTrain/pages/payment/index',
                  })
                },
                fail(err){
                  console.log(err)
    ...
    request({
      ...
      if(res.code == 200 && res.data){
        ...
        this.setData({
          ...
          order_id:res.data.id,//订单ID
          allPrice:res.data.price/100,//价格
          from:res.data.travel_around.location_assemble,//出发地
          to:res.data.travel_around.location_dismiss,//目的地 
        })
      }
    })
  },
